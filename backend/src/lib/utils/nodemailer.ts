...
export const sendVerificationEmail = async ({ username, email, verificationToken, url }) => {
...
export const sendResetPasswordEmail = async ({ username, email, passwordToken, url }) => {
